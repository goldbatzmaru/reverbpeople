				...
				<div id="page-heading" class="<?php wope_var($heading_class);?> <?php wope_var($heading_align_class);?>">
					<div class="wrap">
						<div id="page-heading-left">
							<h1 id="page-title">
								<?php printf( esc_html__( 'Tag Archives: %s', 'mega' ),  single_tag_title( '', false )  ); ?>
							</h1>
						</div>
						<div id="breadcrumb">
							<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_html_e('Home','mega');?></a><span> / <span><?php printf( esc_html__( 'Tag Archives: %s', 'mega' ),  single_tag_title( '', false )  ); ?></span>
						</div>
