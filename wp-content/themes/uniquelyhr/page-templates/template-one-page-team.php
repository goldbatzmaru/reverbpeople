<?php
/**
 * Template Name: Homepage (One Page Team)
		...
		<section id="homepage-portfolio">
			...
			<div class="container">
				...
				<div class="row">
						...
						<div class="logo-items one-third column<?php echo $clearleft; ?>">
							<?php if ( get_field ( 'logo_link' ) ){ ?>
								<a href="<?php the_field( 'logo_link' )?>" target="_blank">
							<?php } ?>	
				...
				<div class="row">
					...
					<div class="eight columns">
						...
						<form class="contact-form" action="<?php echo get_template_directory_uri(); ?>/form/form.php" method="post">
						    ...
						    <textarea name="message" placeholder="<?php _e( 'Question', 'cabana' ); ?>"></textarea>
