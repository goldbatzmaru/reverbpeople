	...
	$sections[] = array(
		...
		'fields' => array(
            ...
            array(
                ...
                'type' => 'section',
                'title' => __( 'Logo Section', 'cabana' ),                          
                'indent' => true // Indent all options below until the next 'section' option is set.
                ),
            array(
            	'id'=>'work-icon',
            	'type' => 'text',
            	'title' => __( 'Logo Icon', 'cabana' ), 
            	'subtitle' => __( 'Please add an icon to appear above your title. eg; [icon name=fa-heart]<br/><br />All list of available icons can be found <a href="http://fortawesome.github.com/Font-Awesome/" target="_blank">here</a>.', 'cabana' ),
			...
			array(
			    ...
			    'type'=> 'editor',
			    'title'=> __( 'Logo Introduction', 'cabana' ), 
			    'subtitle' => __( 'Please enter a short overview to appear in the logo section.', 'cabana' ),
			    'required' => array('home-options-select', '=' , array( 2,3,4 ) ),
			    'default'=> '<p>Proactively envisioned multimedia based expertise and cross-media growth strategies. Seamlessly visualize quality intellectual capital without superior collaboration and idea-sharing.</p><p>Holistically pontificate installed base portals after maintainable products are produced and shared leading to fantastic results.</p>',
			    'editor_options'=> array(
			        'teeny'=> true,
			...
			array(
				'id'=>'work-button-text',
				'type' => 'text',
				'title' => __( 'Logo Button Text', 'cabana' ), 
				'subtitle' => __( 'Please enter text for your logo button.<br /><br />eg; See all work.', 'cabana' ),
				'default'  => 'Button Text'
				),
			array(
				...
				'type' => 'select',
				'data' => 'pages',
				'title' => __( 'Logo Button URL', 'cabana' ), 
				'subtitle' => __( 'Please choose a page for your log button to link to.<br />eg; Portfolio', 'cabana' ),
				'placeholder' => 'Choose a Page',
				),
		     array(
				'id'=>'section-work-end',
